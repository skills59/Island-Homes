...
<option value="Petrol">For Sale</option>
<option value="Diesel">For Rent</option>
<option value="CNG">Short Lease</option>
</select>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Publish Year<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" required>
</div>
<label class="col-sm-2 control-label">No Of Rooms<span style="color:red">*</span></label>
<div class="col-sm-4">
