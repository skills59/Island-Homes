...
?>
													...
													<div class="stat-panel-title text-uppercase">Property Type</div>
												</div>
											</div>
											<a href="manage-vehicles" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
													...
													<div class="stat-panel-title text-uppercase">Message Enquiries</div>
												</div>
											</div>
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Property Option</div>
												</div>
											</div>
											<a href="manage-brands" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
...
?>
											...
											<a href="manage-subscribers" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
											...
											<a href="manage-conactusquery" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
