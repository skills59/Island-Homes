		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages?type=terms">terms and condition</option>
                  <option value="manage-pages?type=privacy">privacy and policy</option>
                  <option value="manage-pages?type=aboutus">aboutus</option> 
                  <option value="manage-pages?type=faqs">FAQs</option>
                </select>
												</div>
											</div>
